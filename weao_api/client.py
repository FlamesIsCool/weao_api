...
class WEAOAPIClient:
    ...
    def update_exploit(self, api_key: str, updated: bool, version: str, feature: bool = False, ping: bool = False, changelog: str = "") -> dict:
        """
        ...
        :param feature: (Optional) True if this is a feature update.
        :param ping: (Optional) Set to False to avoid pinging the Discord server.
        :param changelog: (Optional) A string with changelog details.
